...
const UploadMaterialClient = ({ editId }) => {
    ...
    const fetchMaterial = async () => {
      ...
      setMaterialData({
        ...
        publicationDate: data.publicationDate ? 
          (() => {
            const [year, month, day] = data.publicationDate.split("-");
            return {
              year: year || "",
  ...
  const handleFileUpload = async (event) => {
    ...
    setMaterialData((prev) => {
      const updated = {...prev, pdf_path: filePath};
      console.log("Updated Material Data with PDF Path:", updated);
      return updated;
    });
...
export default UploadMaterialClient;
